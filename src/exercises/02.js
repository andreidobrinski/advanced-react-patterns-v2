...
class Toggle extends React.Component {
  ...
  // use Boolean so that when it returns false, it won't render
  // eg. returning a 0 in the case of list.length might still return a 0 instead of false w/o Boolean
  static On = props => (Boolean(props.on) && props.children)
